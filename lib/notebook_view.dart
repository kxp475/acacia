            	...
            	children: [
              		Container(
              			...
              			child: Column(
              				...
              				children: <Widget> [
              					paddingA,
              					Text("  This Month's", textAlign: TextAlign.left, style: new TextStyle(fontSize: 25, fontWeight: FontWeight.normal, color : Colors.black)),
              					Text("  ${args.name}", textAlign: TextAlign.left, style: new TextStyle(fontSize: 25, fontWeight: FontWeight.bold, color : Colors.black)),
              					paddingA,
              					new Expanded(
              		...
              		Container(
              			...
              			child: Column(
              				...
              				children: <Widget> [
              					Text(" Add Data", textAlign: TextAlign.left, style: new TextStyle(fontSize: 25, fontWeight: FontWeight.bold, color : Colors.black)),
              				],
              			),
              		),
              		Container(
              			...
              			child: Column(
              				...
              				children: <Widget> [
              					Text(" Insights", textAlign: TextAlign.left, style: new TextStyle(fontSize: 25, fontWeight: FontWeight.bold, color : Colors.black)),
              				],
              			),
              		),
